...
public class peminjaman extends javax.swing.JFrame {
    ...
    private void teangan() {
     ...
     private void struk(){
         if (kdpeminjaman.getText().isEmpty()) {
            ...
            g.drawString("PERPUSTAKAAN SMK TI MUHAMMADIYAH CIKAMPEK", 35, 22);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(99, 426, -1, -1));
    ...
    private void tabledorMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabledorMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_tabledorMouseEntered
