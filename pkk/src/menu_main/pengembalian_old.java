 ...
 * @author SEKDES
 */
public class pengembalian_old extends javax.swing.JFrame {

    /**
     * Creates new form pengembalian
     */
    public pengembalian_old() {
        initComponents();
        load_table();
        kosong();
        cbbpinjam();
    ...
    private void initComponents() {
        ...
        jPanel1.add(hapuse, new org.netbeans.lib.awtextra.AbsoluteConstraints(77, 608, -1, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pengembalian_old.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pengembalian_old().setVisible(true);
            }
        });
    }
